<html>
	...
	<body>
		...
		#caractertísticas producto comestible-frescos
		
		$pid = $_GET['pid'];
		$query = "SELECT Productos.nombre, Productos.descripción, Productos.precio, ProductosComestibles.fecha_expiración, ProductosFrescos.duración FROM Productos, ProductosComestibles, ProductosFrescos WHERE Productos.pid = $pid AND ProductosComestibles.pid = Productos.pid AND ProductosFrescos.pid = Productos.pid;";
		...
		<section class="hero">
			<div class="content">
				<table class="table" id = "v1">
					...
					<th class = "title has-text-white has-text-centered">Duración</th>
					</thead>
					<?php
