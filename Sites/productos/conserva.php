<html>
	...
	<body>
		...
		#caractertísticas producto comestible-conserva
		
		$pid = $_GET['pid'];
		$query = "SELECT Productos.nombre, Productos.descripción, Productos.precio, ProductosComestibles.fecha_expiración, ProductosEnConserva.método FROM Productos, ProductosComestibles, ProductosEnConserva WHERE Productos.pid = $pid AND ProductosComestibles.pid = Productos.pid AND ProductosEnConserva.pid = Productos.pid;";
		...
		<section class="hero">
			<div class="content">
				<table class="table" id = "v1">
					...
					<th class = "title has-text-white has-text-centered">Conservación</th>
					</thead>
					<?php
